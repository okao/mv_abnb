	...
	return (
		<div className="nc-CommentCard flex ">
			...
			<div className="flex-grow flex flex-col p-4 ml-2 text-sm border border-neutral-200 rounded-xl sm:ml-3 sm:text-base dark:border-neutral-700">
				...
				<div>
					<button
						className="inline-flex items-center min-w-[68px] rounded-full text-neutral-6000 bg-gray-100 dark:text-neutral-200 dark:bg-gray-800 px-3 h-8 hover:bg-teal-50 hover:text-teal-600 dark:hover:text-teal-500 focus:outline-none "
						title="Reply"
					>
						<svg
