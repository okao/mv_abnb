...
const GuestsInput: FC<GuestsInputProps> = ({
	...
	return (
		<div
			className={`flex z-10 relative ${className}`}
			ref={refContainer}
		>
			<div
			...
			{isOpen && (
				<div className="h-8 absolute self-center top-1/2 -translate-y-1/2 z-0 -left-0.5 right-10 bg-white dark:bg-gray-800"></div>
			)}

			{isOpen && (
				<div className="absolute right-0 z-30 w-full sm:min-w-[340px] max-w-sm bg-white dark:bg-gray-800 top-full mt-3 py-5 sm:py-6 px-4 sm:px-8 rounded-3xl shadow-xl">
					<NcInputNumber
						className="w-full"
