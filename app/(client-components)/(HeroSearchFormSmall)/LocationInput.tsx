...
const LocationInput: FC<LocationInputProps> = ({
				...
				<div className="mt-2">
					{[
						...
						<span
							...
							key={item}
							className="flex px-4 sm:px-6 items-center space-x-3 py-4 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
						>
	...
	return (
		<div className={`relative flex ${className}`} ref={containerRef}>
			...
			{showPopover && (
				<div className="absolute left-0 z-40 w-full min-w-[300px] sm:min-w-[400px] bg-white dark:bg-gray-800 top-full mt-3 py-3 sm:py-5 rounded-3xl shadow-xl max-h-96 overflow-y-auto">
