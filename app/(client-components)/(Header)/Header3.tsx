...
const Header3: FC<Header3Props> = ({ className = '' }) => {
		...
		return (
			...
			>
				<div className="flex items-center font-medium text-sm">
					...
					<span className="h-5 w-[1px] bg-gray-300 dark:bg-gray-700"></span>
					<span
	...
	return (
		<>
			...
			>
				<div
					className={`bg-white dark:bg-gray-900 absolute h-full inset-x-0 top-0 transition-transform will-change-[transform,opacity]
