...
const CarCardH: FC<CarCardHProps> = ({
	...
	return (
		<div
			className={`nc-CarCardH group relative bg-white dark:bg-gray-900 border border-neutral-200/80 dark:border-neutral-700 rounded-2xl overflow-hidden ${className}`}
		>
