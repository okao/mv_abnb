...
const FlightCard: FC<FlightCardProps> = ({
	...
	return (
		<div
			className={`nc-FlightCardgroup p-4 sm:p-6 relative bg-white dark:bg-gray-900 border border-neutral-100
     dark:border-neutral-800 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow space-y-6 ${className}`}
		>
			<div className={` sm:pr-20 relative  ${className}`}>
				...
				<span
					className={`absolute right-0 bottom-0 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 w-10 h-10 bg-gray-50 dark:bg-gray-800 rounded-full flex items-center justify-center cursor-pointer ${
