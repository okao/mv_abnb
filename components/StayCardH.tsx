...
const StayCardH: FC<StayCardHProps> = ({
	...
	return (
		<div
			className={`nc-StayCardH group relative bg-white dark:bg-gray-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl overflow-hidden hover:shadow-xl transition-shadow ${className}`}
		>
