...
const ExperiencesCardH: FC<ExperiencesCardHProps> = ({
	...
	return (
		<div
			className={`nc-ExperiencesCardH group relative bg-white dark:bg-gray-900 border border-neutral-200/80 dark:border-neutral-700 rounded-2xl overflow-hidden ${className}`}
		>
