...
const CardAuthorBox2: FC<CardAuthorBox2Props> = ({
	...
	return (
		<Link
			href={href}
			className={`nc-CardAuthorBox2 flex flex-col overflow-hidden bg-white dark:bg-gray-900 rounded-3xl hover:shadow-xl transition-shadow ${className}`}
		...
		>
			<div className="relative flex-shrink-0 ">
				...
				<div className="absolute top-3 inset-x-3 flex">
					<div className="py-1 px-4 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center leading-none text-xs font-medium">
