...
const VIDEOS_DEMO: VideoType[] = [
	{
		id: 'Ao7e4iisKMs',
		title:
			'Magical Scotland - 4K Scenic Relaxation Film with Calming Music',
		thumbnail:
...
const SectionVideos: FC<SectionVideosProps> = ({
	...
	const renderMainVideo = () => {
		...
		return (
			<div
				className="group aspect-w-16 aspect-h-16 sm:aspect-h-9 bg-gray-800 rounded-3xl overflow-hidden border-4 border-white dark:border-neutral-900 sm:rounded-[50px] sm:border-[10px] will-change-transform"
				title={video.title}
			>
				{isPlay ? (
					<iframe
		...
		<div className={`nc-SectionVideos ${className}`}>
          ...
          perspectives on just about any topic. Everyone’s welcome."
			...
			<div className="flex flex-col relative sm:pr-4 sm:py-4 md:pr-6 md:py-6 xl:pr-14 xl:py-14 lg:flex-row">
				<div className="absolute -top-4 -bottom-4 -right-4 w-2/3 rounded-3xl bg-primary-100 bg-opacity-40 z-0 sm:rounded-[50px] md:top-0 md:bottom-0 md:right-0 xl:w-1/2 dark:bg-gray-800 dark:bg-opacity-40"></div>
