...
const AnyReactComponent: FC<AnyReactComponentProps> = ({
	...
	return (
		...
		>
			<span
				className={`flex px-2 py-1 rounded-lg bg-white dark:bg-gray-900 text-sm font-semibold items-center justify-center min-w-max shadow-lg hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-neutral-900 transition-colors ${
					isSelected
				...
				<div className="absolute z-50 bottom-full pb-3 -left-12 w-[260px] aspect-w-1">
					...
					{experiences && (
						<ExperiencesCard
							...
							className="shadow-2xl bg-white dark:bg-gray-900 rounded-3xl"
						/>
					)}
					{car && (
						<CarCard
