...
const PropertyCardH: FC<PropertyCardHProps> = ({
	...
	return (
		<div
			className={`nc-PropertyCardH group relative bg-white dark:bg-gray-900 border border-neutral-200/80 dark:border-neutral-700 rounded-3xl overflow-hidden ${className}`}
		>
			...
			<BtnLikeIcon
				colorClass={` bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 hover:bg-opacity-70 text-neutral-6000 dark:text-neutral-400`}
				isLiked={like}
